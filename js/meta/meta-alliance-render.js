      ...
      panel.innerHTML = [
        ...
        '<div class="scroll" style="flex:1;overflow-y:auto;padding:12px;">',
          '<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">',
            ...
            '</div>',
          '</div>',
          '<div role="status" aria-label="War active — defense layout locked" style="',
            'display:flex;align-items:center;gap:6px;',
            'background:rgba(180,60,20,0.12);border:1px solid rgba(180,60,20,0.35);',
            'border-radius:6px;padding:5px 10px;margin-bottom:10px;">',
            '<span style="font-size:11px;">🔒</span>',
            '<span style="font-size:10px;color:#c06840;letter-spacing:1px;font-weight:700;text-transform:uppercase;">',
              'WAR ACTIVE — layout locked',
            '</span>',
          '</div>',
