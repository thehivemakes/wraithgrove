...
(function () {
  ...
  const EVENT_MAP = [
    ...
    // Architect 2026-05-09 — dopamine cascade audio. Stopgap reuses existing
    // CC0 samples; replace with bespoke when budget allows.
    { event: 'audio:spirit_surge',    id: 'skill_burst',   bus: 'sfx', throttleMs: 0,   vol: 1.0 },
    { event: 'audio:wraith_unleash',  id: 'levelup_chime', bus: 'sfx', throttleMs: 0,   vol: 0.9 },
